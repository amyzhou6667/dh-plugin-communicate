...
6. `docs/superpowers/specs/2026-09-03-deepseek-harness-bridge-design.md` - 技术设计文档
7. `docs/superpowers/plans/2026-09-03-deepseek-harness-bridge.md` - 迭代计划文档
...
## 相关文档
- [技术设计文档](./2026-09-03-deepseek-harness-bridge-design.md)
- [迭代计划文档](../plans/2026-09-03-deepseek-harness-bridge.md)
- [产品需求文档](../../PRD/README.md)
- [技术架构文档](../../TAD/README.md)
- [测试用例文档](../../TEST/README.md)
- [API接口定义](../../api/openapi.yaml)
